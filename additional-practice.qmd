...
If you choose to install the package via the terminal, place your code in the unlabeled chunk; otherwise, place your code in the python chunk. 
...
A key for this exam can be found [here](https://unl-statistics.github.io/stat850/activities/additional-practice-key.qmd).
